...
Vel = jQuery ? jQuery.Velocity : $ ? $.Velocity : Velocity,
                ...
                return "open" === b ? (this.each(function() {
                    ...
                    function e(b) {
                        ...
                        var q = 0,
                            r = 0,
                            s = g.parent();
                        if (s.is("body") || (s[0].scrollHeight > s[0].clientHeight && (q = s[0].scrollTop), s[0].scrollWidth > s[0].clientWidth && (r = s[0].scrollLeft)), k + j.innerWidth() > a(window)
                            .width() ? m = "right" : k - j.innerWidth() + g.innerWidth() < 0 && (m = "left"), l + j.innerHeight() > c)
                            if (l + e - j.innerHeight() < 0) {
                                var t = c - l - p;
                                j.css("max-height", t)
                            } else p || (p += e), p -= j.innerHeight();
                        if ("left" === m) n = h.gutter, o = g.position()
                            .left + n;
                        else if ("right" === m) {
                            var u = g.position()
                    ...
                    function f() {
                        i = !1, j.fadeOut(h.outDuration), j.removeClass("active"), g.removeClass("active"), a(document)
                            .unbind("click." + j.attr("id") + " touchstart." + j.attr("id")), setTimeout(function() {
                                j.css("max-height", "")
                            }, h.outDuration)
                    }
                    var g = a(this),
                    ...
                    if (d(), g.after(j), h.hover) {
                        ...
                        i || (g[0] != b.currentTarget || g.hasClass("active") || 0 !== a(b.target)
                            ...
                            .length ? g.hasClass("active") && (f(), a(document)
                                .unbind("click." + j.attr("id") + " touchstart." + j.attr("id"))) : (b.preventDefault(), h.stopPropagation && b.stopPropagation(), e("click")))
                    });
    ...
    function(a) {
        a.fn.parallax = function() {
            ...
            return this.each(function(c) {
                function d(c) {
                    var d;
                    d = b < 601 ? e.height() > 0 ? e.height() : e.children("img")
            ...
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    var c, d, e, f, g, h = a(this),
                        ...
                        q = function(a) {
                            return k - a.position()
                                .left - a.outerWidth() - h.scrollLeft()
                        },
                        r = function(a) {
                            return a.position()
                                .left + h.scrollLeft()
                    ...
                    b.swipeable && i > b.responsiveThreshold && (b.swipeable = !1), c = a(j.filter('[href="' + location.hash + '"]')), 0 === c.length && (c = a(this)
                            .find("li.tab a.active")
                            .first()), 0 === c.length && (c = a(this)
                            .find("li.tab a")
                            .first()), c.addClass("active"), n = j.index(c), n < 0 && (n = 0), void 0 !== c[0] && (d = a(c[0].hash), d.addClass("active")), h.find(".indicator")
                        .length || h.append('<div class="indicator"></div>'), f = h.find(".indicator"), h.append(f), h.is(":visible") && setTimeout(function() {
                            f.css({
                                right: q(c)
                            }), f.css({
                                left: r(c)
                        ...
                        .resize(function() {
                            ...
                            }), e = l.wrapAll('<div class="tabs-content carousel" style="height: 900px"></div>'), l.css("height", "900px"), a(".tabs-content.carousel")
                            .carousel({
                                fullWidth: !0,
                                noWrap: !0,
                        ...
                        .each(function() {
                            ...
                            if (a(this)
                                .parent()
                                .hasClass("disabled")) return void e.preventDefault();
                            if (!a(this)
                                .attr("target")) {
    ...
    function(a) {
        ...
        var b = function(b, c, d, e) {
            var f = b,
                g = c;
            return f < 0 ? f = 4 : f + d > window.innerWidth && (f -= f + d - window.innerWidth), g < 0 ? g = 4 : g + e > window.innerHeight + a(window)
            ...
            init: function(b) {
                ...
                b = a.extend(c, b), a(this)
                    .each(function() {
                        ...
                        b.draggable ? (f.length && f.remove(), f = a('<div class="drag-target"></div>')
                                .attr("data-sidenav", d), a("body")
                                .append(f)) : f = a(), "left" == b.edge ? (e.css("transform", "translateX(-100%)"), f.css({
                                left: 0
                            })) : (e.addClass("right-aligned")
                                .css("transform", "translateX(100%)"), f.css({
                                    right: 0
                                })), e.hasClass("fixed") && window.innerWidth > 992 && e.css("transform", "translateX(0)"), e.hasClass("fixed") && a(window)
                            .resize(function() {
                                window.innerWidth > 992 ? 0 !== a("#sidenav-overlay")
                                    .length && i ? g(!0) : e.css("transform", "translateX(0%)") : i === !1 && ("left" === b.edge ? e.css("transform", "translateX(-100%)") : e.css("transform", "translateX(100%)"))
                                ...
                                .bind("pan", function(c) {
                                    if ("touch" == c.gesture.pointerType) {
                                        var d = (c.gesture.direction, c.gesture.center.x),
                                            ...
                                            h = a("#sidenav-overlay"),
                                            j = f.innerWidth();
                                        if (f.css("overflow", "hidden"), f.width(j), 0 === h.length && (h = a('<div id="sidenav-overlay"></div>'), h.css("opacity", 0)
                                                .click(function() {
                                                    g()
                                                }), a("body")
                                                .append(h)), "left" === b.edge && (d > b.menuWidth ? d = b.menuWidth : d < 0 && (d = 0)), "left" === b.edge) d < b.menuWidth / 2 ? i = !1 : d >= b.menuWidth / 2 && (i = !0), e.css("transform", "translateX(" + (d - b.menuWidth) + "px)");
                                        else {
    ...
    function(a) {
        ...
        a.scrollSpy = function(b, d) {
            ...
            return h || (e.on("scroll", l), e.on("resize", l), h = !0), setTimeout(l, 0), b.on("scrollSpy:enter", function() {
                ...
                var b = a(this);
                i[0] ? (a('a[href="#' + i[0].attr("id") + '"]')
                        .removeClass("active"), b.data("scrollSpy:id") < i[0].data("scrollSpy:id") ? i.unshift(a(this)) : i.push(a(this))) : i.push(a(this)), a('a[href="#' + i[0].attr("id") + '"]')
                    .addClass("active")
            }), b.on("scrollSpy:exit", function() {
                if (i = a.grep(i, function(a) {
                        return 0 != a.height()
                    }), i[0]) {
                    a('a[href="#' + i[0].attr("id") + '"]')
                        .removeClass("active");
                    var b = a(this);
                    i = a.grep(i, function(a) {
                ...
                Materialize.updateTextFields = function() {
                    ...
                    a(b)
                        .each(function(b, c) {
                            ...
                            a(c)
                                .val()
                                .length > 0 || c.autofocus || void 0 !== d.attr("placeholder") ? d.siblings("label")
                                .addClass("active") : a(c)[0].validity ? d.siblings("label")
                                .toggleClass("active", a(c)[0].validity.badInput === !0) : d.siblings("label")
                                .removeClass("active")
                        })
                };
                ...
                a(document)
                    ...
                    .on("blur", c, function() {
                        ...
                        var b = void 0 !== a.attr("data-length"),
                            ...
                            .length;
                        0 === a.val()
                            .length && a[0].validity.badInput === !1 ? a.hasClass("validate") && (a.removeClass("valid"), a.removeClass("invalid")) : a.hasClass("validate") && (a.is(":valid") && b && d <= c || a.is(":valid") && !b ? (a.removeClass("invalid"), a.addClass("valid")) : (a.removeClass("valid"), a.addClass("invalid")))
                    };
                ...
                a(document)
                    ...
                    .on("input mousedown touchstart", h, function(b) {
                        ...
                        c.length <= 0 && (c = a('<span class="thumb"><span class="value"></span></span>'), a(this)
                            ...
                            .addClass("active"), c.hasClass("active") || c.velocity({
                                ...
                                .left : b.pageX - a(this)
                                .offset()
                                .left, g < 0 ? g = 0 : g > d && (g = d), c.addClass("active")
                    ...
                    .on("mousemove touchmove", j, function(b) {
                        ...
                        if (i) {
                            ...
                            var e = a(this)
                                .outerWidth();
                            c < 0 ? c = 0 : c > e && (c = e), d.addClass("active")
                    ...
                    .on("mouseout touchleave", j, function() {
                        ...
                        return b = a.extend(c, b), this.each(function() {
                            ...
                            if (!a.isEmptyObject(e)) {
                                ...
                                h.length ? (i = h.children(".autocomplete-content.dropdown-content")
                                    .first(), i.length || h.append(j)) : (i = d.next(".autocomplete-content.dropdown-content"), i.length || d.after(j)), i.length && (j = i);
                                var k = function(a, b) {
                                        var c = b.find("img"),
                                            d = b.text()
                                            .toLowerCase()
                                ...
                                d.off("keyup.autocomplete")
                                    .on("keyup.autocomplete", function(g) {
                                        if (f = 0, 13 !== g.which && 38 !== g.which && 40 !== g.which) {
                                            ...
                                            if (c !== h && (j.empty(), l(), "" !== h))
                                                for (var i in e)
                                                    if (e.hasOwnProperty(i) && i.toLowerCase()
                                                        .indexOf(h) !== -1 && i.toLowerCase() !== h) {
                                                        if (f >= b.limit) break;
                                                        var m = a("<li></li>");
                                    ...
                                    .on("keydown.autocomplete", function(a) {
                                        var b, c = a.which,
                                            ...
                                            e = j.children(".active")
                                            .first();
                                        return 13 === c ? (b = j.children("li")
                                            .eq(g), void(b.length && (b.click(), a.preventDefault()))) : void(38 !== c && 40 !== c || (a.preventDefault(), 38 === c && g > 0 && g--, 40 === c && g < d - 1 && e.length && g++, e.removeClass("active"), j.children("li")
                                            .eq(g)
                                            .addClass("active")))
        ...
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    function d(a) {
                        a >= j.length ? a = 0 : a < 0 && (a = j.length - 1), k = i.find(".active")
                    ...
                    var e, f, g, h = a(this),
                        ...
                        k = i.find(".active")
                        .index();
                    k != -1 && (e = j.eq(k)), h.hasClass("fullscreen") || (b.indicators ? h.height(b.height + 40) : h.height(b.height), i.height(b.height)), j.find(".caption")
                        .each(function() {
                            c(a(this), 0)
                        }), j.find("img")
                        .each(function() {
        ...
        a(document)
            .ready(function() {
                ...
                d.hasAutocomplete = !a.isEmptyObject(e.autocompleteData), this.init = function() {
                    ...
                    var b = d.SELS;
                    d.$document.off("click.chips-focus", b.CHIPS)
                        .on("click.chips-focus", b.CHIPS, function(c) {
                            a(c.target)
                                .find(b.INPUT)
                                .focus()
                        }), d.$document.off("click.chips-select", b.CHIP)
                        .on("click.chips-select", b.CHIP, function(c) {
                            ...
                            if (e.length) {
                                var f = e.hasClass("selected"),
                                    g = e.closest(b.CHIPS);
                                a(b.CHIP)
                                    .removeClass("selected"), f || d.selectChip(e.index(), g)
                            }
                        }), d.$document.off("keydown.chips")
                            ...
                            if (!a(c.target)
                                ...
                                if (f.length)
                                    if (8 === c.which || 46 === c.which) {
                                        ...
                                        var i = null;
                                        e + 1 < h ? i = e : e !== h && e + 1 !== h || (i = h - 1), i < 0 && (i = null), null !== i && d.selectChip(i, g), h || g.find("input")
                                            .focus()
                                    } else if (37 === c.which) {
                                    if (e = f.index() - 1, e < 0) return;
                                    a(b.CHIP)
                                        .removeClass("selected"), d.selectChip(e, g)
                                } else if (39 === c.which) {
                                    if (e = f.index() + 1, a(b.CHIP)
                                        .removeClass("selected"), e > h) return void g.find("input")
                                        .focus();
                                    d.selectChip(e, g)
                                }
                            }
                        }), d.$document.off("focusin.chips", b.CHIPS + " " + b.INPUT)
                        .on("focusin.chips", b.CHIPS + " " + b.INPUT, function(c) {
                            ...
                            d.addClass("focus"), d.siblings("label, .prefix")
                                ...
                                .removeClass("selected")
                        }), d.$document.off("focusout.chips", b.CHIPS + " " + b.INPUT)
                        .on("focusout.chips", b.CHIPS + " " + b.INPUT, function(c) {
                            ...
                            d.removeClass("focus"), d.data("chips")
                                ...
                                .removeClass("active")
                        }), d.$document.off("keydown.chips-add", b.CHIPS + " " + b.INPUT)
                        .on("keydown.chips-add", b.CHIPS + " " + b.INPUT, function(c) {
                            var e = a(c.target),
                                ...
                                .length;
                            if (13 === c.which) {
                                if (d.hasAutocomplete && f.find(".autocomplete-content.dropdown-content")
                                    .length && f.find(".autocomplete-content.dropdown-content")
                                    .children()
                                    .length) return;
                        ...
                        }), d.$document.off("click.chips-delete", b.CHIPS + " " + b.DELETE)
                        .on("click.chips-delete", b.CHIPS + " " + b.DELETE, function(c) {
                            var e = a(c.target),
                                f = e.closest(b.CHIPS),
                                g = e.closest(b.CHIP);
                            c.stopPropagation(), d.deleteChip(g.index(), f), f.find("input")
                                .focus()
                        })
                    ...
                    var g = b.next("label");
                    g.length && (g.attr("for", c), b.data("chips")
                        .length && g.addClass("active"));
                    var h = a("#" + c);
                    ...
                    a.data("chips")
                        .length && e.placeholder ? a.find("input")
                        .prop("placeholder", e.placeholder) : !a.data("chips")
                        .length && e.secondaryPlaceholder && a.find("input")
                    ...
                    if (d.isValid(c, b)) {
                        ...
                        f.push(b), c.data("chips", f), a(e)
                            .insertBefore(c.find("input")), c.trigger("chip.add", b), d.setPlaceholder(c)
                    }
    ...
    function(a) {
        ...
        c.prototype.set = function(a, b, c) {
            ...
            return c = void 0 === c ? a : c,
                c == -(1 / 0) || c == 1 / 0 ? e = c : b.isPlainObject(c) && f.isInteger(c.pick) ? c = c.obj : b.isArray(c) ? (c = new Date(c[0], c[1], c[2]), c = f.isDate(c) ? c : g.create()
            ...
            return f.isInteger(a) && f.isInteger(c) || "boolean" == typeof a && "boolean" == typeof c ? a === c : (f.isDate(a) || b.isArray(a)) && (f.isDate(c) || b.isArray(c)) ? d.create(a)
                .pick === d.create(c)
                .pick : !(!b.isPlainObject(a) || !b.isPlainObject(c)) && (d.isDateExact(a.from, c.from) && d.isDateExact(a.to, c.to))
            ...
            return f.isInteger(a) && (f.isDate(c) || b.isArray(c)) ? (a = a % 7 + e, a === d.create(c)
                ...
                .day + 1) : !(!b.isPlainObject(a) || !b.isPlainObject(c)) && d.overlapRanges(a, c)
        ...
        var b = {
            init: function(b) {
                ...
                return b = a.extend(c, b), this.each(function() {
                    ...
                    if (J.hasClass("initialized")) return a(this)
                        .trigger("carouselNext", [1e-6]), !0;
                    if (b.fullWidth) {
                        b.dist = 0;
                        var L = J.find(".carousel-item img")
                            .first();
                        L.length ? imageHeight = L.on("load", function() {
                                ...
                                .first()
                                .height(), J.css("height", imageHeight)), K && J.find(".carousel-fixed-item")
                            .addClass("with-indicators")
                    }
                    J.addClass("initialized"), t = !1, r = A = 0, o = [], p = J.find(".carousel-item")
                        .first()
                        .innerWidth(), q = J.find(".carousel-item")
                        .first()
                        .innerHeight(), u = 2 * p + b.padding, J.find(".carousel-item")
                        .each(function(b) {
                        ...
                        .on("resize.carousel", function() {
                            b.fullWidth ? (p = J.find(".carousel-item")
                                .first()
                                .innerWidth(), q = J.find(".carousel-item")
                                .first()
                                .innerHeight(), u = 2 * p + b.padding, r = 2 * s * p, A = r) : g()
                        }), c(), g(r), a(this)
